...
export default function KegiatanPage() {
  ...
  function handleExport() {
    ...
    const dataToExport = activityData.map((row) => ({
        ...
        "Sasaran: Remaja": row.sasaranRemaja,
        "Sasaran: Lansia": row.sasaranLansia,
        "Sasaran: Bufus": row.sasaranBufus,
        "Sasaran: Busu": row.sasaranBusu,
        "Sasaran: Bayi": row.sasaranBayi,
        "Sasaran: Dewasa": row.sasaranDewasa,
        "Total Sasaran": row.totalSasaran,
        "Pengunjung: Balita": row.pengunjungBalita,
        "Pengunjung: Bumil": row.pengunjungBumil,
        "Pengunjung: Remaja": row.pengunjungRemaja,
        "Pengunjung: Lansia": row.pengunjungLansia,
        "Pengunjung: Bufus": row.pengunjungBufus,
        "Pengunjung: Busu": row.pengunjungBusu,
        "Pengunjung: Bayi": row.pengunjungBayi,
        "Pengunjung: Dewasa": row.pengunjungDewasa,
